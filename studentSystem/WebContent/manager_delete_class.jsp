...
<jsp:useBean id="classes" class="com.javabeans.Classes" scope="session"></jsp:useBean>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
		...
		<div class="mainer">
			<div class="admin-navbar">
            	...
            	<li class="active"><a href="manager_delete_student.jsp" >信息删除</a>
            	    ...
            	    <li class="active"><a href="manager_delete_class.jsp">删除班级</a></li>
		...
		<div class="tab">
			...
			<div class="tab-body">
				...
				<div class="tab-panel active" id="tab-set">
					<form action="DeleteClassServlet" method="post" class="form-x" >
						<div class="form-group">
							<div class="label">
								<label for="old_password">班级编号：</label>
							</div>
							<div class="field">
								<input type="text" class="input" id="cno"
									name="cno" size="30" style="width: 100px"
