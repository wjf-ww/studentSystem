...
<body>
<div class="lefter">
    <div class="logo"><a href="login.jsp" target="_blank"></a></div>
</div>
<div class="righter nav-navicon" id="admin-nav">
    <div class="mainer">
		...
		<div class="tab">
			<div class="tab-head">
				<strong>添加班级信息</strong>
			</div>
			<div class="tab-body">
				<br />
				<div class="tab-panel active" id="tab-set">
					<form action="AddClassServlet" method="post" class="form-x" >
						<div class="form-group">
							<div class="label">
								<label for="sno">班级编号：</label>
							</div>
							<div class="field">
						...
						<div class="form-group">
							<div class="label">
								<label for="spassword">班级名称：</label>
							</div>
							<div class="field">
								<input type="text" class="input" id="cname"
									name="cname" size="30" style="width: 150px"
									placeholder="班级名称" data-validate="required:请填写班级名称" />
							</div>
						</div>
						<div class="form-group">
							<div class="label">
							...
							<div class="field">
								<input type="text" class="input" id="cmajor"
									name="cmajor" size="30" style="width: 150px"
									placeholder="专业名称" data-validate="required:请填写专业名称" />
							</div>
						</div>
