...
<jsp:useBean id="course" class="com.javabeans.Course" scope="session"></jsp:useBean>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
		...
		<div class="mainer">
			<div class="admin-navbar">
            	...
            	<li class="active"><a href="manager_delete_student.jsp" >信息删除</a>
            	    <ul><li><a href="manager_delete_student.jsp">删除学生</a></li>
            	    <li><a href="manager_delete_teacher.jsp">删除教师</a></li>
            	    <li><a href="manager_delete_class.jsp">删除班级</a></li>
            	    <li class="active"><a href="manager_delete_course.jsp">删除课程</a></li></ul>
            	</li>
		...
		<div class="tab">
			...
			<div class="tab-body">
				...
				<div class="tab-panel active" id="tab-set">
					<form action="DeleteCourseServlet" method="post" class="form-x" >
						<div class="form-group">
							<div class="label">
								<label for="old_password">课程编号：</label>
							</div>
							<div class="field">
								<input type="text" class="input" id="Ccno"
									name="Ccno" size="30" style="width: 100px"
